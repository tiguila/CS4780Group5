...
public class TripleSDESBruteForce {
    ...
    */
    ...
    // start: 400,000
    private static int bruteForceIterations = 401400+100+100+100+100; // limit is 524800, upper bound
    private static int bruteForceLowerBound = 401400+100+100+100; // lower bound
    ...
    public static void main(String[] args) {
        ...
        System.out.println("This is the size: " + crossProduct.size());

        long endTime = System.nanoTime();

        long elapsedTime = endTime - startTime;

        System.out.println("Time taken: " + (elapsedTime / 1e6)/1000 + " sec"); // Convert to milliseconds
